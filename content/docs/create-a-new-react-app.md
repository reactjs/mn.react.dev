...
Та Node >= 8.10, npm >= 5.6-г компьютертээ суулгах шаардлагатай. Create React App нь JavaScript-ын хамгийн сүүлийн үеийн боломжуудыг ашиглах боломжтой хѳгжүүлэлтийн орчин бүрдүүлж ѳгѳхѳѳс гадна, хэрэглэгчид хүрэх үед нэмэлт сайжруулалтуудыг автоматаар хийдэг. Тѳсѳл үүсгэхдээ*:
...
- **[Nx](https://nx.dev/react)** нь бүтэн stack нэг агуулахт хөгжүүлэлтэнд зориулсан React, Next.js, [Express](https://expressjs.com/) зэргийн дэмжлэгтэй хэрэгсэл(toolkit) юм.
