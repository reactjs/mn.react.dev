...
Утга нь зөвхөн унших горимд байдаг учир энэ нь React дээр **удирдагдаагүй** компонент болно. Үнийг бусад удирдагдаагүй компонентуудын хамт [дараа нь өөр баримтжуулалт](/docs/uncontrolled-components.html#the-file-input-tag) ярина.
