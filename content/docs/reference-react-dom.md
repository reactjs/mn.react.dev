...
Хэрэв та `<script>` тагаар React-ыг ачаалах юм бол эдгээр ахисан түвшний API-ууд нь `ReactDOM` глобал дээр байна. Хэрэв та npm-тай хамт ES6 ашиглавал та `import ReactDOM from 'react-dom'` гэж бичиж болно. Хэрэв npm-тай хамт ES5 ашиглах юм бол `var ReactDOM = require('react-dom')` гэж бичих боломжтой. 

## Тойм {#overview}

`react-dom` пакэж нь DOM-д тохирсон арга ба та аппынхаа ахисан түвшинд ашиглах боломжтой. Ингэснээр хэрэг болбол React моделиос гадна яаралтай үед ашиглах боломжтой болох юм. Ихэнх компонентууд энэ модулийг ашиглах шаардлагагүй. 
...
React элементийг DOM руу `container` дотор рендэр хийгээд [reference](/docs/more-about-refs.html)-ээ компонент руу буцаана (эсвэл [төлөвгүй компонентууд](/docs/components-and-props.html#functional-and-class-components)-ыг `null` гэнэ)).
