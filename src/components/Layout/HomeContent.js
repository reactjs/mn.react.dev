    ...
    <>
      <div className="ps-0">
        ...
        <Section background="left-card">
          <Center>
            <Header>Компонентуудаар хэрэглэгчийн интерфэйс бүтээ</Header>
            <Para>
              React нь тусдаа биеэ даасан хэсгүүд болох компонентуудаар
              хэрэглэгчийн интерфэйс бүтээх боломж олгодог. Жишээ нь{' '}
              <Code>Thumbnail</Code>, <Code>LikeButton</Code>, мөн{' '}
              <Code>Video</Code> г.м React компонентуудаа бүтээгээд, дараа нь
              эдгээрийг хуудас, нүүр болон апп даа зориулж хольж угсарна.
            </Para>
          </Center>
          <FullBleed>
            <Example1 />
          ...
          <Center>
            <Para>
              Өөрийнхөө компонент эсвэл хүний бичсэн компонент дээр ажиллах нь
              огт ялгаагүй санагдах ба, React нь хэний ч бичсэн компонент
              хоорондоо ямар ч асуудалгүй ашиглах боломжтойгоор бүтээгдсэн.
            </Para>
          </Center>
        </Section>
        ...
        <Section background="right-card">
          <Center>
            <Header>Компонентоо код болон маркап хольж бичээрэй</Header>
            <Para>
              React компонентууд нь JavaScript функууд юм. Контентоо ямар нэг
              нөхцөлтэйгээр харуулах шаардлагатай бол <Code>if</Code> нөхцөл
              ашиглана. Жагсаалт харуулах уу? Массив-ын <Code>map()</Code>{' '}
              ашигла. React сурах нь яг л програмчлал сурахтай адил.
            </Para>
          </Center>
          <FullBleed>
            <Example2 />
          ...
          <Center>
            <Para>
              Энэ маркап синтакс React нэмэлтээр бүтээсэн JavaScript синтакс юм.
              JSX маркапаа хамааралтай рендер логиктой ойр байлгаснаар React
              компонентийг бүтээх, сайжруулах, устгах нь илүү хялбар болно.
            </Para>
          </Center>
        </Section>
        ...
        <Section background="left-card">
          <Center>
            <Header>Хүссэн үедээ интерактив байдал нэмэх боломж</Header>
            <Para>
              React компонентууд дата хүлээж аваад, юуг яаж дэлгэцэнд харагдах
              ёстойг буцаадаг. Жишээ нь хэрэглэгч бичих талбарт юм бичихээр
              React шинэ дата-д зориулан дэлгэцийг өөрчилнө.
            </Para>
          </Center>
          <FullBleed>
            <Example3 />
          ...
          <Center>
            <Para>
              Та бүхэлд нь React дээр бүтээх албагүй. Аль хэдийн үүсгэсэн HTML
              хуудас дээр React оруулаад интерактив React компонентоо хүссэн
              газраа ашиглаж болно
            </Para>
        ...
        <Section background="right-card">
          <Center>
            <Header>
              Full-stack фреймворк <br className="hidden lg:inline" />
              ашиглаарай
            </Header>
            <Para>
          ...
          <Center>
            <Para>
              React нь мөн архитектур юм. Фреймворкууд нь өгөгдлийг сервер дээр
              байхдаа эсвэл бүр build хийх үед асинхрон татах чадвартай
              компонент үүсгэх боломжтойгоор бүтээгдсэн байдаг. Дата-г файлаас
              эсвэл өгөгдлийн сангаас уншаад интерактив компонентрууга
              дамжуулдаг.
            </Para>
            <div className="flex justify-start w-full lg:justify-center">
              <CTA
        ...
        <Section background="left-card">
          <div className="mx-auto flex flex-col w-full">
            <div className="mx-auto max-w-4xl lg:text-center items-center px-5 flex flex-col">
              <Header>Платформ бүрийг хамгийн сайнаар ашиглах</Header>
              <Para>
                Хүмүүст вэб болон натив апп янз бүрийн шалтгаанаар таалагддаг.
                React нь нэг мэдлэгээр вэб апп болон натив апп бүтээх боломжийг
                олгодог. Платформ бүрийн онцлогт тааруулан таны бүтээсэн
                интерфэйсийг яг зөв харагдуулдаг.
              </Para>
            </div>
                  ...
                  <div className="relative overflow-hidden">
                    ...
                    <div className="relative flex items-start justify-center flex-col flex-1 pb-16 pt-5 gap-3 px-5 lg:px-10 lg:pt-8">
                      ...
                      <p className="lg:text-xl leading-normal text-secondary">
                        Вэб апп нь хурдан уншдаг байх шаардлагатай. Сервер
                        талдаа, дата татах үедээ HTML дээр татагдсан дата-г ямар
                        нэг JavaScript код ажиллаж эхлэхээс өмнө зурах
                        чадвартай. Харин хэрэглэгч талдаа, React нь стандарт вэб
                        API-уудыг ашиглаж рендер хийж байхад хүртэл UI -ыг зөв
                        ажииллуулна.
                      </p>
                    </div>
                  </div>
                    ...
                    <div className="bg-gradient-right dark:bg-gradient-right-dark px-3 sm:px-3 pb-12 lg:pb-20 rounded-lg overflow-hidden">
                      ...
                      <div className="flex flex-col items-start justify-center pt-0 gap-3 px-2.5 lg:pt-8 lg:px-8">
                        ...
                        <p className="h-full lg:text-xl text-secondary dark:text-secondary-dark leading-normal">
                          Хүмүүс натив апп нь яг л платформын өөрийнх нь апп шиг
                          мэдрэгдэхийг хүсдэг.{' '}
...
>>>>>>> 6bfde58c109ec86fd6c5767421404cb679ffba9a
            ...
            <div className="px-5 lg:px-0 max-w-4xl mx-auto lg:text-center text-secondary dark:text-secondary-dark">
              <Para>
                React ашиглаж вэб <i>болон</i> натив хөгжүүлэгч болдог. Танай
                баг платформ тус бүрт гэхгүйгээр бүхэлд нь хариуцаад хэрэглэгчид
                мэдрэгдэх мэдрэмжийг өөрчлөлгүйгээр олон платформд
                бүтээгдэхүүнээ гаргах боломжтой.
              </Para>
              <div className="flex justify-start w-full lg:justify-center">
                <CTA color="gray" icon="native" href="https://reactnative.dev/">
                  Натив платформуудад зориулж бүтээх нь
                </CTA>
              </div>
            </div>
          </div>
...
>>>>>>> 6bfde58c109ec86fd6c5767421404cb679ffba9a
                <Para>
                  ...
                  100,000 гаруй React компонентууд шилжилт бүрийг
                  баталгаажуулдаг.
                </Para>
                <div className="order-last pt-5">
                  <Para>
                    React баг үргэлж React-ыг хэрхэн сайжруулах талаар судалж
                    байдаг. Зарим судалгаа нь үр дүнгээ өгөх хүртэл хэдэн жил ч
                    болдог. Судалгааны санааг бүтээгдэхүүн болгоход өндөр босго
                    тавьдаг. Зөвхөн батлагдсан арга л React-ын нэг хэсэг болдог.
                  </Para>
                  <div className="hidden lg:flex justify-start w-full">
                    <CTA color="gray" icon="news" href="/blog">
                      React -ын талаар мэдээ
                    </CTA>
                  </div>
                </div>
              </div>
        ...
        <Section background="left-card">
          <div className="w-full">
            <div className="mx-auto flex flex-col max-w-4xl">
              <Center>
                <Header>
                  Сая сая хүмүүсд <br className="hidden lg:inline" />
                  нэгдэх
                </Header>
                <Para>
                  Сар бүр React-ын гарын авлагад дэлхийн өнцөг булан бүрээс 2
                  сая гаруй хөгжүүлэгчид зочилдог. React бол хүмүүс болон
                  багуудын санал нэгтэй шийдэл.
                </Para>
              </Center>
            </div>
            <CommunityGallery />
            <div className="mx-auto flex flex-col max-w-4xl">
              <Center>
                <Para>
                  Ийм учраас React нь зүгээр нэг сан, архитектур эсвэл
                  экосистeмээс ч илүүтэй, React бол тусламж авах, боломж олох,
                  шинэ найзуудтай болох газар юм. Энд та хөгжүүлэгч, дизайнер,
                  анхлан суралцагч, туршлагатай мэргэжилтэн, судлаач, урлагийн
                  хүн, багш, оюутан зэрэг хүмүүстэй учрах болно. Гарал нь өөр
                  боловч React бид бүгдэд хамтдаа хэрэглэгчийн интерфэйс бүтээх
                  боломж олгож байна.
                </Para>
              </Center>
            </div>
